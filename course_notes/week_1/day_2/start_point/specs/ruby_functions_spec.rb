...
class FunctionsTest < MiniTest::Test
  ...
  def test_fahrenheit_to_celsius()
    celsius_value = fahrenheit_to_celsius(52)
    assert_equal(11, celsius_value)
  end

  def test_volume_of_sphere_exact()
    sphere_volume = volume_of_sphere_exact(3.0)
    assert_equal(113.10, sphere_volume)
  end
